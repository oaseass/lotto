...
const DAILY_FORTUNE_POOL: Record<string, string[]> = {
  ...
  금: [
    ...
    '논리적 사고와 분석력이 뛰어난 날입니다.',
    '자기 계발과 실력 향상에 좋은 기운입니다. 학습에 투자하세요.',
    '금(金) 기운이 잠잠합니다. 내실 있는 준비를 하세요.',
    '책임감과 의리가 빛나는 날입니다.',
    '장기 계획을 점검하고 수정하기 좋은 날입니다.',
    '완벽함을 추구하되 융통성도 발휘해야 합니다.',
    '권위와 전문성이 주목받는 날입니다.',
    '핵심을 꿰뚫는 통찰력이 돋보이는 날입니다.',
    '금(金) 기운으로 재물의 흐름이 명확해집니다.',
  ],
  수: [
    '수(水) 기운이 유연하게 흐릅니다. 어떤 상황에도 잘 적응할 수 있습니다.',
    '깊은 통찰력과 지혜가 빛나는 날입니다.',
    '인간관계에서 깊은 유대가 형성됩니다.',
    '직관과 예감이 정확한 날입니다. 내면의 소리에 귀 기울이세요.',
    '지식과 정보 수집에 탁월한 날입니다.',
    '재물이 물처럼 흐르는 날입니다. 지출 관리에 신경쓰세요.',
    '창의적 문제 해결 능력이 탁월한 날입니다.',
    '감수성이 풍부해지는 날입니다. 명상이나 자기 성찰로 내면을 정비하세요.',
    '수(水)의 지혜로 복잡한 상황을 꿰뚫을 수 있습니다.',
    '목표를 향해 유연하게 흘러가는 날입니다.',
